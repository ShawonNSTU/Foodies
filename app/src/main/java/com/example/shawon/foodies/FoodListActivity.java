...
public class FoodListActivity extends AppCompatActivity {
  ...
  /*      callbackManager = CallbackManager.Factory.create();
                        ...
                        mDatabaseRating.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.hasChild(mSearchAdapter.getRef(position).getKey())){
                                    ...
                                    Intent intent = new Intent(FoodListActivity.this,ShowCommentActivity.class);
    ...
    private void loadSuggestFood(String catagoryID) {

        mDatabaseFood.orderByChild("menu_id").equalTo(catagoryID).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
